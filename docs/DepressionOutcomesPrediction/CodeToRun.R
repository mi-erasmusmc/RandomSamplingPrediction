...
# library(DepressionOutcomesPrediction)
#=======================
# USER INPUTS
#=======================

# The folder where the study intermediate and result files will be written:
outputFolder <- "./DepressionOutcomesPredictionResults"
...
cohortTable <- 'DepressionOutcomesPredictionCohort'
...
databaseDetails <- createDatabaseDetails(
  ...
  cohortId = 5430,
  outcomeIds = c(5412:5415,5418:5429,5431:5435),
  cdmVersion = 5
)
...
plpData <- getPlpData(databaseDetails, covariateSettings, restrictPlpDataSettings)

savePlpData(plpData, 'PlpData', envir = NULL, overwrite = F)
